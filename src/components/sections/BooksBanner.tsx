  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 max-w-4xl mx-auto space-y-4 px-4 flex flex-col items-center">
        ...
        {/* Eyebrow */}
        <span className="text-[10px] uppercase tracking-[0.3em] font-serif-cinzel text-brand-gold font-bold">
          {language === "en" ? "Publications Library" : "ஆவிக்குரிய நூலகம்"}
        </span>

        {/* Main Title (Masthead style) */}
        <h2 className="text-4xl sm:text-6xl md:text-7xl font-serif-cinzel tracking-widest text-brand-cream font-bold uppercase leading-none">
          {language === "en" ? "Books" : "நூல்கள்"}
        </h2>

        {/* Subtitle */}
        <p className="text-lg sm:text-2xl font-serif-cormorant italic text-brand-gold font-light">
