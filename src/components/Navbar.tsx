  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 w-full bg-brand-cream/95 backdrop-blur-md border-b border-brand-gold/25 shadow-sm select-none">
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden border-t border-brand-gold/25 bg-brand-cream/98 px-4 py-6 space-y-4 shadow-inner">
            {navLinks.map((link) => {
              const isActive = pathname === link.path;
              return (
                <Link
      ...
      {donateModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-brand-cream border border-brand-gold/50 max-w-lg w-full p-8 md:p-10 relative shadow-2xl animate-fadeIn">
            {/* Interior frame */}
